...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class DialogueEntry
    {
        ...
        /// <summary>
        /// States of dialogue actors when entry occurs.
        /// Each state described by the list of fields.
        /// </summary>
        public List<ActorState> actorsStates = null;
        ...
        public DialogueEntry(ChatMapper.DialogEntry chatMapperDialogEntry)
        {
            if (chatMapperDialogEntry != null)
            {
                ...
                actorsStates = new List<ActorState>();
                UseCanvasRectField();
