...
namespace Dialogue
{
    ...
    public class CDialogueActorsPanel : MonoBehaviour
    {
        ...
        public void ShowActors( CDialogueActorsArrangements arrangements, List<CDialogueActorImage> actorImages, string leadingActor )
        {
            Assert.IsNotNull( arrangements );
        ...
        private void SetActorsImages( List<CDialogueActorImage> actorsImages )
        {
