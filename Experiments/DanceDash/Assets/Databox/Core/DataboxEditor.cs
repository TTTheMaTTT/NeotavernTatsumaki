												...
												if (_databaseType.TryGetValue(_type, out _dataType))
												{
													...
													using (new GUILayout.HorizontalScope())
													{
														...
														using (new GUILayout.HorizontalScope("Box"))
														{
															...
															#if UNITY_EDITOR
															if (GUILayout.Button(new GUIContent(iconReset, "Reset value back to initial value"), GUILayout.Width (40)))
															#else
															...
															{
																#if UNITY_EDITOR
																if (GUILayout.Button(new GUIContent(iconTrashIcon, "Remove value"), GUILayout.Width (40)))
																{
